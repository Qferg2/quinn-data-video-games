...
def interesting_info():
    ...
    print(game)
    return render_template('page1.html', options = get_game_options(games), name = game, info = get_interesting_info(games, game), info1 = get_interesting_info1(games, game))
